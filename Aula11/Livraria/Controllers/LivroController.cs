...
namespace Livraria.Controllers
{
    public class LivroController : Controller
    {
        ...
        //Inicializa o atributo contexto.
        ...
        {
            return View(await contexto.Livro.Include(e => e.Editora).
                              OrderBy(l => l.Titulo).ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            if (id == null)
                return NotFound("O livro com Id - " + id + " não foi encontrado.");
